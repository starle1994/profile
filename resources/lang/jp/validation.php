...
return [
    ...
    */
    ...
    'attributes' => [],
    'valid_isalphabet'  => 'アルファベット文字だけご利用できます！',
    'is_not_numeric'    => '整数だけご入力ください！',
    'invalid_numeric'   => '不正なナンバー',
    'alpha_no_spaces'      => ':attributeアルファベット文字だけご利用できます',
    'alpha_spaces'  => 'アルファベット文字とスペースだけご利用できます！',
    'invalid_usercode'     => ' は不正です',
];
